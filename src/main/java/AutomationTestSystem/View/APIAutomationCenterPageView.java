...
public class APIAutomationCenterPageView extends Application {
...
//    	HomePageView.HomePageInterfaceStage.close();
        ...
        static AnchorPane APIAutomationCenterPane = new AnchorPane();
...
//	    		VideoPlayerRectangle.setHeight(886);
		...
		public static void APIAutomationCenter() throws Exception{
        	    APIAutomationCenterPane.setLayoutX(222);
        	    APIAutomationCenterPane.setLayoutY(115);
        	    APIAutomationCenterPane.setPrefWidth(1381);
        	    APIAutomationCenterPane.setPrefHeight(886);
        	    APIAutomationCenterPane.setId("APIAutomationCenterPane");
        	    APIAutomationCenterPane.setVisible(false);
...
//	    	                	DownloadProgressBar.progressProperty().bind(Worker.progressProperty());
	    		    			...
	    		    			timer.schedule(new TimerTask() {
	    		    				@Override
	    		    				public void run() {
//	    		    					SoftwareEngineering="RestAssured";
	                ...
	                public void handle(ActionEvent event) {
	                    if(StringUtil.isEmpty(SoftwareEngineeringField.getText())){
		                	...
		                	try{
			                	...
			                	fileChooser.setInitialDirectory(new File(System.getProperty("user.home")+"\\AppData\\Local\\AutomationTestSystem\\app\\"+SoftwareEngineering+"\\src\\test\\java\\TestCaseXls"));                 
			                	File file = fileChooser.showOpenDialog(HomePageInterfaceStage);
			                	if (file != null) {
			                		String TestObjectPath = file.getPath();
...
//			                            System.out.println(file.getPath());
	    	    ...
	    	    MailModeButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
	    	  	    ...
	    	  	    public void handle(MouseEvent event) {
  	            	  ...
  	            	  APIAutomationCenterPane.getChildren().add(MailModeListView);	
	    	  	    }
	    	  	});
				                	...
				                	timer.schedule(new TimerTask() {
				        				...
				        				public void run() {
				        					...
				        					try {
				        						...
				        						ScriptRunLogTextArea.appendText("[RestAssured项目] 脚本打包编译中...");
			    			                	Command("Scripts",mvn);
			    			                	ScriptRunLogTextArea.appendText("\n");
			    			                	ScriptRunLogTextArea.appendText("[RestAssured项目] 脚本打包编译成功...");
			    			                	ScriptRunLogTextArea.appendText("\n");
			    								ScriptRunLogTextArea.appendText("-------------------------------------------------------------------------------------------------------------------");
			    								ScriptRunLogTextArea.appendText("\n");
			    			                	ScriptRunLogTextArea.appendText("[RestAssured项目] Ant脚本运行中...");
			    								Command("Scripts",ant);
			    								ScriptRunLogTextArea.appendText("\n");
			    								ScriptRunLogTextArea.appendText("[RestAssured项目]Ant 脚本运行成功...");
			    								ScriptRunLogTextArea.appendText("\n");
			    								ScriptRunLogTextArea.appendText("-------------------------------------------------------------------------------------------------------------------");
...
//    					String EntryName = "RestAssured";
	    	    ...
	    	    APIAutomationCenterPane.getChildren().add(DownloadProgressBar);
	    	    APIAutomationCenterPane.getChildren().add(DownloadProgressLabel);
	    	    
	    	    APIAutomationCenterPane.getChildren().add(SoftwareEngineeringField);
	    	    APIAutomationCenterPane.getChildren().add(SoftwareEngineeringButton);
	    	    
        	    APIAutomationCenterPane.getChildren().add(ConfigurationFileField);
	    	    APIAutomationCenterPane.getChildren().add(ConfigurationFileButton);
	    	    
	    	    APIAutomationCenterPane.getChildren().add(TestObjectField);
	    	    APIAutomationCenterPane.getChildren().add(TestObjectButton);
	    	    
	    	    APIAutomationCenterPane.getChildren().add(TestScriptsField);
	    	    APIAutomationCenterPane.getChildren().add(TestScriptsButton);
	    	    
	    	    APIAutomationCenterPane.getChildren().add(TestScriptsAggregateField);
	    	    APIAutomationCenterPane.getChildren().add(TestScriptsAggregateButton);
	    	    		
	    	    APIAutomationCenterPane.getChildren().add(CommitMessageTextArea);
	    	    APIAutomationCenterPane.getChildren().add(MailModeField);
	    	    APIAutomationCenterPane.getChildren().add(MailModeButton);
	    	    APIAutomationCenterPane.getChildren().add( SendPeopleNumberField);
	    	    APIAutomationCenterPane.getChildren().add( AddresseeOneField);
	    	    APIAutomationCenterPane.getChildren().add(AddresseeTwoField);
	    	    APIAutomationCenterPane.getChildren().add(AddresseeThreeField);
	    	    APIAutomationCenterPane.getChildren().add(AddresseeFourField);

	    	    APIAutomationCenterPane.getChildren().add(ScriptRunLogTextArea);
	    	    
	    	    APIAutomationCenterPane.getChildren().add(HomePageView.AccountLoginCenterPane); 
	    	    APIAutomationCenterPane.getChildren().add(ScriptUploadButton);
	    	    APIAutomationCenterPane.getChildren().add(ScriptDownloadButton);
	    	    APIAutomationCenterPane.getChildren().add(ScriptRunButton);
	    	    APIAutomationCenterPane.getChildren().add(GenerationReportButton);
	    	    APIAutomationCenterPane.getChildren().add(SendMailButton);
	    	    
        	    HomePagePane.getChildren().add(APIAutomationCenterPane);
//        	    HomePageView.HomePagePane.getChildren().add(APIAutomationCenterPane);
        }

    	public static void getAPIAutomationCenterPane(boolean show) {
         	APIAutomationCenterPane.setVisible(show);
     	}

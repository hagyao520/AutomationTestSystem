...
public class LoginPageView extends Application {
    ...
    public void LoginInterface() throws Exception {
        ...
        for (int i = 0; i < size; i++) {
            // data.addAll(list.get(0).getAccount(), list.get(1).getAccount(), list.get(2).getAccount(),
...
//        });
    ...
    public void LoadingInterface() {
        ...
        LoadingLabel.setTextFill(new LinearGradient(0, 0, 1, 1, true, CycleMethod.REPEAT, new Stop[] {new Stop(0, Color.AQUAMARINE), new Stop(0.5f, Color.BLANCHEDALMOND)}));
